...
def main():
    ...
    try:
        ...
        print(f"Error: {e}")
        print("\nPlease generate Qwen2 VL embeddings first:")
        print("  python embedding_pipeline_qwen2vl.py")
        return
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        # Save checkpoint
        checkpoint_path = os.path.join(CHECKPOINT_DIR, f"mhms_qwen2vl_epoch_{epoch}.pth")
        torch.save({
            'epoch': epoch,

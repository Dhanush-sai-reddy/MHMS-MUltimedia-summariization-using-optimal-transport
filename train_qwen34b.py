"""
Training Script for MHMS with Qwen 34B Unified Embeddings
==========================================================
Trains the MHMS framework using Qwen 34B embeddings.
...
from mhms.dataset_qwen34b import CNNMultimodalDatasetQwen3VL
from mhms.models.mhms_framework_qwen34b import MHMS_Qwen3VL
...
def main():
    # Configuration
    DATA_DIR = "cnn_data"
    EMBEDDINGS_DIR = "embeddings_qwen34b"
    CHECKPOINT_DIR = "checkpoints_qwen34b"
    ...
    try:
        ...
        print(f"Error: {e}")
        print("\nPlease generate Qwen 34B embeddings first:")
        print("  python embedding_pipeline_qwen34b.py")
        return
    ...
    # Initialize model
    print("\nInitializing MHMS model with Qwen 34B embeddings...")
    model = MHMS_Qwen3VL(
        embedding_dim=EMBEDDING_DIM,
        video_hidden_dim=VIDEO_HIDDEN_DIM,
        text_hidden_dim=TEXT_HIDDEN_DIM,
    ...
    # Training loop
    print("\n" + "=" * 60)
    print("  Starting Training (Qwen 34B Unified Embeddings)")
    print("=" * 60)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        # Save checkpoint
        checkpoint_path = os.path.join(CHECKPOINT_DIR, f"mhms_qwen34b_epoch_{epoch}.pth")
        torch.save({
            'epoch': epoch,
    ...
    # Save final model
    final_path = os.path.join(CHECKPOINT_DIR, "mhms_qwen34b_final.pth")

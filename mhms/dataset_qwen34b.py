...
class CNNMultimodalDatasetQwen34B(Dataset):
    def __init__(self, data_dir="cnn_data", embeddings_dir="embeddings_qwen34b", 
        ...
        if not os.path.exists(text_dir) or not os.path.exists(visual_dir):
            raise ValueError(
                ...
                f"Please run: python embedding_pipeline_qwen34b.py"
            )
        ...
        print(f"Qwen34B Dataset initialized with {len(self.samples)} valid multimodal cases.")
